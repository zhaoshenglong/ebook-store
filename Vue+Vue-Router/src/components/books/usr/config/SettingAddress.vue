            ...
            <div>
                <div id="region-block">
                    ...
                    <ul id="province" v-show="showRegion">
                        <li class="region-list" v-for="provin in provinFilter"
                        :key="provin" @click="modifyProv(provin)">{{provin}}</li>
                    </ul>
                    <ul id="city" v-show="showRegion">
                        <li class="region-list" v-for="city in cityFilter"
                        :key="city" @click="modifyCity(city)">{{city}}</li>
                    </ul>
                    <ul id="district" v-show="showRegion">
                        <li class="region-list" v-for="dist in distFilter"
                        :key="dist" @click="modifyDist(dist)">{{dist}}</li>
                    </ul>
                </div>
...
export default {
    ...
    methods: {
        watchMouse() {
            ...
            if (id != 'province' && id != 'city' 
                && id != 'district' && id != 'input-region'
                && claName != 'region-list')
